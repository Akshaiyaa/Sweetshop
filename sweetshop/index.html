...
<head>
    ...
    <title>Sweet shop web page</title>
                ...
                <div class="tm-left-right-container">
                    ...
                    <div class="tm-blue-bg tm-left-column">                        
                        <div class="tm-logo-div text-xs-center">
                            ...
                            <h1 class="tm-site-name">Abc Sweets</h1>
                        </div>
                    ...
                    <div class="tm-right-column">
                        ...
                        <div class="tm-content-div">
                            ...
                            <section id="welcome" class="tm-section">
                                <header>
                                    <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">Welcome to Abc Sweets</h2>
                                </header>
                                <p>Welcome to Abc Sweets! You can fnd all kinds of popular Indian sweets here! Explore to your heart's content! Orders will be delivered within an hour of placing them.</p>
                            </section>
                            <!-- About section -->
                            <section id="about" class="tm-section">
                                <div class="row">                                                                
                                    ...
                                    <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 pull-lg-8 pull-md-7 tm-about-img-container">
                                        <img src="img/02.jpg" alt="Image" class="img-fluid">    
                                    </div>  
                                </div>                            
                            </section>  
